...
| 18 | Sprache des Schriftverkehrs an Mitarbeiter | Fuer ein Mitarbeiterkonto ist keine Sprachvorliebe hinterlegt. Derzeit gilt die Sprache der Sitzung, die den Versand ausloest, beim ersten Administrator die Standardsprache. Soll `Employees` ein Sprachfeld erhalten? | mehrsprachige Belegschaft | offen |
| 19 | Wartezimmer-Anzeige | Die Anzeige folgt der am Geraet gewaehlten Sprache. Fachlich waere auch eine gleichzeitige Darstellung in allen drei Sprachen denkbar, weil im Wartezimmer gemischte Sprachgruppen sitzen. Was gilt? | Aufstellung der Anzeige im Publikumsbereich | offen |
| 20 | Uebersetzung der Stammdaten | `Service.Floor` wird nicht uebersetzt und erscheint in allen Sprachen unveraendert. Bei rein numerischen Etagenangaben ist das richtig, bei Angaben wie „Erdgeschoss" nicht. Soll `Floor` ebenfalls uebersetzbar werden? | erste Etagenangabe in Textform | offen |
